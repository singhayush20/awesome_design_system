...
import 'required_indicator.dart';

/// A versatile text input component with validation states, sizing, and theming.
...
class _DSInputState extends State<DSInput> {
  ...
  Widget build(BuildContext context) {
    final DSInputThemeData? inputTheme =
        Theme.of(context).extension<DSInputThemeData>();
    ...
    final DSInputStyle defaultStyle = inputTheme?.style ??
        DSInputStyle(
    ...
    final InputDecoration decoration = InputDecoration(
      ...
      fillColor: defaultStyle.fillColor ??
          _resolveFillColor(widget.isDisabled, hasError, colors),
      contentPadding: defaultStyle.contentPadding ??
          _resolveContentPadding(widget.size, spacing),
      labelStyle: defaultStyle.labelStyle,
      hintStyle: defaultStyle.hintStyle,
      helperStyle: defaultStyle.helperStyle,
      errorStyle: defaultStyle.errorStyle,
      counterStyle: defaultStyle.counterStyle,
    ...
    if (widget.isRequired && widget.label != null) {
      textField = DSRequiredIndicator(child: textField, label: widget.label!);
    }
